...
pub(crate) struct ResolvedSpeculativeConfig {
    ...
    pub(crate) spd_manifest_path: Option<PathBuf>,
    pub(crate) spd_fixture_path: Option<PathBuf>,
    pub(crate) spd_model_path: Option<PathBuf>,
    pub(crate) pairing_fault: String,
    pub(crate) draft_max_tokens: u32,
    pub(crate) spd_max_tokens: u32,
