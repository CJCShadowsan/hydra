...
pub(crate) use stage::{
    ...
    spawn_stage_control_loop, stage_downstream_wire_condition_value_from_env, stage_load_timeout,
};
#[cfg(test)]
...
impl SkippyModelHandle {
    ...
    pub(crate) fn load_with_hooks(
        ...
        let binding = embedded_openai_backend(EmbeddedOpenAiArgs {
            ...
            pipelined_speculative_depth: embedded_args.pipelined_speculative_depth,
            tree_speculative: embedded_args.tree_speculative,
            ...
            downstream_wire_condition: stage_downstream_wire_condition_value_from_env()?,
