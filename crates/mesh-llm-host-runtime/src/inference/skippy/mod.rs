...
impl SkippyModelHandle {
    ...
    pub(crate) fn load_with_hooks(
        ...
        let binding = embedded_openai_backend(EmbeddedOpenAiArgs {
            ...
            spd_manifest_path: embedded_args.spd_manifest_path,
            spd_fixture_path: embedded_args.spd_fixture_path,
            spd_model_path: embedded_args.spd_model_path,
            spd_top_k: embedded_args.spd_top_k,
            spd_n_gpu_layers: embedded_args.spd_n_gpu_layers,
            spd_replay_fallback: embedded_args.spd_replay_fallback,
            spd_optimistic_decode: embedded_args.spd_optimistic_decode,
            spd_rolling_executor: embedded_args.spd_rolling_executor,
            spd_optimistic_min_logit_margin: embedded_args.spd_optimistic_min_logit_margin,
