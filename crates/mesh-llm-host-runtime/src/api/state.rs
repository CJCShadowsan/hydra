...
pub(super) struct ApiInner {
    ...
    pub(super) hydra_scheduler_config: hydra::SchedulerConfig,
    pub(super) placement_vast_trigger_config: Option<hydra::VastTriggerConfig>,
    pub(super) placement_manager: hydra::PlacementManager,
